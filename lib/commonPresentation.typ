#import "common.typ": authors, course, date, linkColor, mainColor, projectName, university
...
#let cover(title) = {
  ...
  align(center + horizon)[
    ...
    #grid(
      ...
      inset: 0.4em,
      [*Team members*], [#authors.lorenzo.name #authors.lorenzo.surname (#authors.lorenzo.stid)],
...
#let slide(title, body) = {
  ...
  align(bottom)[
    ...
    #grid(
      ...
      inset: 1em,
      stroke: mainColor,
      [#course], [#projectName], [Slide #context (counter(page).display()) of #context (counter(page).final().at(0))],
    )
  ]
}
